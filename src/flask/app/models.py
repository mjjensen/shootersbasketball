...
from app import db, teamsdb


class Competitions(teamsdb.Competitions, AuditMixin, db.Model):
...
class People(teamsdb.People, AuditMixin, db.Model):
    __bind_key__ = 'teamsdb'
...
class Venues(teamsdb.Venues, AuditMixin, db.Model):
    __bind_key__ = 'teamsdb'
...
class Teams(teamsdb.Teams, AuditMixin, db.Model):
    __bind_key__ = 'teamsdb'
    __tablename__ = 'teams'
    __table_args__ = (
...
class Sessions(teamsdb.Sessions, AuditMixin, db.Model):
    __bind_key__ = 'teamsdb'
